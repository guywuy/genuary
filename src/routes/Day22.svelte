<script>
  ...
  onMount(() => {
    ...
    function draw(t) {
      ...
      const timeMap = map(time, 0, duration, halfSpacer, spacer*4) * sinMod; // Extent that the control point should 'bend' the quadratic curve
...
<h1 class="page-title">Negative Space Combination</h1>
